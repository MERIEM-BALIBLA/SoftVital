<nav class="relative py-1 flex justify-between px-6 md:px-60 items-center bg-white ">
    ...
    <div class="hidden lg:flex">
        ...
        @else
            <div
                class="text-lg lg:flex-grow flex justify-center items-center text-gray-500 px-4 mx-auto font-semibold font-heading space-x-12">
                <a href="/">
                    Page d'accueil
                </a>
                ...
                @elseif(auth()->user()->role->first()->role === 'patient')
                    <a href="liste_de_mes_rendez-vous">Mes rendez-vous</a>
                @endif
            </div>
        @endif
    </div>
            ...
            <div class="pt-6">
                ...
                @else
                    ...
                    @if (auth()->user()->role->first()->role === 'medecin')
                        ...
                        <a class="block m-1 bg-gray-100 border border-gray-300 text-black  hover:bg-gray-100 dark:text-gray-300 dark:bg-gray-700 px-4 py-3 mb-3 text-sm text-center font-semibold rounded-xl"
                            href="{{ route('calandrier') }}">
                            Mon calandrier
                        </a>
                        <a class="block m-1 bg-gray-100 border border-gray-300 text-black  hover:bg-gray-100 dark:text-gray-300 dark:bg-gray-700 px-4 py-3 mb-3 text-sm text-center font-semibold rounded-xl"
                            href="{{ route('Mes-rendez-vous') }}">
                            Mes rendez-vous
                        </a>
                    @endif
                    @if (auth()->user()->role->first()->role === 'admin')
                    ...
                    @elseif(auth()->user()->role->first()->role === 'patient')
                    <a class="block m-1 bg-gray-100 border border-gray-300 text-black  hover:bg-gray-100 dark:text-gray-300 dark:bg-gray-700 px-4 py-3 mb-3 text-sm text-center font-semibold rounded-xl"
                    href="liste_de_mes_rendez-vous">Mes rendez-vous</a>
                    <a class="block m-1 bg-gray-100 border border-gray-300 text-black  hover:bg-gray-100 dark:text-gray-300 dark:bg-gray-700 px-4 py-3 mb-3 text-sm text-center font-semibold rounded-xl"
                    href="/docteur-profil">Prendre un rendez-vous</a>
                    @endif
